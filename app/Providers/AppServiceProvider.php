...
use App\Domains\Operations\Policies\DomainActivityPolicy;
use App\Domains\Operations\Policies\FollowUpPolicy;
...
use App\Domains\Product\Policies\BrandPolicy;
use App\Domains\Product\Policies\ProductCategoryPolicy;
use App\Domains\Product\Policies\ProductPolicy;
use App\Domains\Product\Policies\ProductVariantPolicy;
use App\Domains\Product\Policies\UnitPolicy;
...
use App\Domains\Website\Livewire\CartBadge;
use App\Domains\Website\Livewire\CartPage;
use App\Domains\Website\Livewire\CheckoutPage;
use App\Domains\Website\Livewire\CheckoutSuccessPage;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Livewire::component('website.cart-page', CartPage::class);
        Livewire::component('website.cart-badge', CartBadge::class);
        Livewire::component('website.checkout-page', CheckoutPage::class);
        Livewire::component('website.checkout-success', CheckoutSuccessPage::class);
        ...
        Gate::policy(Fulfillment::class, FulfillmentPolicy::class);
        Gate::policy(FollowUp::class, FollowUpPolicy::class);
        Gate::policy(DomainActivity::class, DomainActivityPolicy::class);
        ...
        Event::listen(UserLoggedIn::class, MergeCartOnLogin::class);
        ...
        Event::listen(QuotationAccepted::class, SendQuotationEmail::class);
        ...
        Event::listen(OrderStatusChanged::class, SendOrderNotification::class);
